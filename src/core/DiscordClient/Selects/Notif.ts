...
import {ComponentInteraction, ComponentInteractionSelectMenuData, Constants} from "eris";

export default {
    custom_id: 'notif',
    async execute(client: DiscordClient, interaction: ComponentInteraction) {
        ...
        const roles = data.values.map(x => configRoles[x as 'Mathématiques']);
